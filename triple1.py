...
class TriplePaneApplication(Adw.Application):
    ...
    def do_activate(self):
        ...
        breakpoint1 = Adw.Breakpoint(condition=Adw.BreakpointCondition.parse_max_width(860))
        breakpoint1.add_setter(outer_view, 'collapsed', True)
        breakpoint1.add_setter(inner_view, 'sidebar-width-fraction', 0.33)

        breakpoint2 = Adw.Breakpoint(condition=Adw.BreakpointCondition.parse_max_width(500))
        ...
        window.add_child(breakpoint1)
        window.add_child(breakpoint2)
