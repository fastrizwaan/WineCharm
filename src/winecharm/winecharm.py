...
try:
    from winecharm import ui, settings, template_manager, runner_manager, single_prefix, restore, backup, winezgui_importer, import_wine_dir, import_game_dir, create_script, check_required_programs, set_wine_arch, script_options
except ImportError:
    import ui
    import settings
