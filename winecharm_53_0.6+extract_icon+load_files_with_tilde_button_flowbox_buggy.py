...
#NEW
    ...
    def create_script_button(self, script):
        ...
        button.connect("clicked", lambda btn: self.on_script_button_clicked(script))

        button.set_tooltip_text(script.stem.replace("_", " "))
        return button

    def on_script_button_clicked(self, script):
        self.selected_script = script
        self.show_options_for_script(script, None)
