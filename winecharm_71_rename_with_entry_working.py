...
#           icon_symlink_path.symlink_to(icon_path)
    ...
    def show_options_for_script(self, script, row):
        ...
        options = [
            ...
            ("Rename Shortcut", "text-editor-symbolic", self.show_rename_shortcut_dialog),
    ...
    def process_ended(self, script_stem):
        if script_stem in self.running_processes:
            ...
            if process_info:
                ...
                # Check if launch_button exists and set the child if it does
...
# /BUGGY
    ...
    def replace_button_with_entry_overlay(self, script, prompt_text, button):
        ...
        if isinstance(parent, Gtk.FlowBoxChild):
            ...
            # Get the script arguments to prefill the entry
            exe_file, wineprefix, progname, script_args = self.extract_yaml_info(script)
            entry = Gtk.Entry()
